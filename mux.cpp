...
public:
    Mux() {
        ...
        int AEB_mux_idx;
        std::string AEB_drive_topic;
        n.getParam("AEB_drive_topic", AEB_drive_topic);
        n.getParam("AEB_mux_idx", AEB_mux_idx);
        add_channel(AEB_drive_topic, drive_topic, AEB_mux_idx);
        ...
        add_channel(gap_drive_topic, drive_topic, gap_mux_idx);

        int pot_mux_idx;
        std::string pot_drive_topic;
        n.getParam("pot_drive_topic", pot_drive_topic);
        n.getParam("pot_mux_idx", pot_mux_idx);
        add_channel(pot_drive_topic, drive_topic, pot_mux_idx);

        int pure_mux_idx;
        std::string pure_drive_topic;
        n.getParam("pure_drive_topic", pure_drive_topic);
        n.getParam("pure_mux_idx", pure_mux_idx);
        add_channel(pure_drive_topic, drive_topic, pure_mux_idx);
